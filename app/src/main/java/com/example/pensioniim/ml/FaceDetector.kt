...
import com.example.pensioniim.camera.LivenessCoordinator.Companion.TARGET_HEIGHT
import com.example.pensioniim.camera.LivenessCoordinator.Companion.TARGET_WIDTH
...
internal class FaceDetector(private val livenessState: com.example.pensioniim.state.LivenessState) {
